...
$bodytag = '<body style="margin-bottom:40px;">
';
if($clean_mode){$dep = '<link rel="icon" type="image/png" href="zh.ico">'; $inmenu = ''; $bodytag = "<body>\n"; }else{

$dep = '

	<meta charset="UTF-8">
	<meta name=viewport  content="width=device-width, initial-scale=1">
	<link rel="icon" 		href="zh.ico" type="image/png" >
	...
	<script src="r/js/script.js'.$d.'"></script>
';
